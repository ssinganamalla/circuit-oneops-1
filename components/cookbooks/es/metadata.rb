...
attribute 'version',
          ...
          :format => {
              ...
              :category => '2.Global',
              :order => 1,
              :form => {'field' => 'select', 'options_for_select' => [['1.1.1', '1.1.1'],['1.3.2', '1.3.2'],['1.4.1', '1.4.1'],['1.4.4', '1.4.4'],
                                                                      ['1.5.0', '1.5.0'],['1.5.1', '1.5.1'],['1.7.1', '1.7.1'],['2.0.0', '2.0.0'],
                                                                      ['2.4.0', '2.4.0'],['5.3.0', '5.3.0'],['5.5.1', '5.5.1'],['5.6.1', '5.6.1']]}
          }
